...
@interface Smith_Jarrod_Project3Object : KrollCoverageObject {
#else
@interface Smith_Jarrod_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Smith_Jarrod_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Smith_Jarrod_Project3Object *_smith_jarrod_project3;
    KrollObject* console;
	BOOL shutdown;
