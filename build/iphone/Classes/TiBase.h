...
// in simulator we redefine to format for Smith_Jarrod_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.smith_jarrod_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.smith_jarrod_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISmith_Jarrod_Project3NativeItemNone = -1, 
	UISmith_Jarrod_Project3NativeItemSpinner = -2,
	UISmith_Jarrod_Project3NativeItemProgressBar = -3,
	
	UISmith_Jarrod_Project3NativeItemSlider = -4,
	UISmith_Jarrod_Project3NativeItemSwitch = -5,
	UISmith_Jarrod_Project3NativeItemMultiButton = -6,
	UISmith_Jarrod_Project3NativeItemSegmented = -7,
	
	UISmith_Jarrod_Project3NativeItemTextView = -8,
	UISmith_Jarrod_Project3NativeItemTextField = -9,
	UISmith_Jarrod_Project3NativeItemSearchBar = -10,
	
	UISmith_Jarrod_Project3NativeItemPicker = -11,
	UISmith_Jarrod_Project3NativeItemDatePicker = -12,
	
	UISmith_Jarrod_Project3NativeItemInfoLight = -13,
	UISmith_Jarrod_Project3NativeItemInfoDark = -14,
	
	UISmith_Jarrod_Project3NativeItemDisclosure = -15,
	
	UISmith_Jarrod_Project3NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Smith_Jarrod_Project3 instances of
